...
TODO: in 'production' non viene usata `trova_indici_vicini`, ma la funzione ottimizzata `get_cyclone_center_pixel_vector` usata nel notebook legacy `Analyze_Manos_tracks.ipynb`; vedere la [reference-track analysis](reference_track_analysis.md). Verificare quale è la migliore e tenere solo quella.
